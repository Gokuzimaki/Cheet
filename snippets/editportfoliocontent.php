<?php
	...
	// for the edit form and the user output
	...
	!isset($maintype)?$pagetype="hometopcollagebox":$pagetype=$maintype;
	...
	// get the form extra data and errormaps here due to conflict with the variable 
	// handling form data injection into generalinfo function
	$extraformdetails='
