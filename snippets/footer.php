<?php 
    include('themescriptsdump.php');
    $securitynumber=rand(0,10).rand(1,8).rand(0,5).rand(10,30).rand(200,250).rand(50,80).rand(34,55).rand(46,57);

?>
 <!-- Begin Footer -->
    <footer class="tz-footer">
        <div class="tz-footer-content tz-footer-content-2 ">
            <div class="container">
                <img src="images/cheetlarge.jpg" alt="Icon-footer">
                <ul class="tz-footer-part">
                    <li>
                        <div class="tz-footer-content-main">
                            <!-- <img src="demos/Home-02/check-02.png" alt="Images remove footer"> -->
