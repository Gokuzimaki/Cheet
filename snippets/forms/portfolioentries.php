				                                	...
				                                	<div class="col-md-3 multi_content_hold " data-name="social" data-type="<?php echo $ttype;?>" data-cid="<?php echo $i?>">
						                                <div class="form-group">
						                                    ...
						                                    <div class="input-group">
				                                    			...
				                                    			<input name="socialname<?php echo $i;?>" 
				                                    			type="hidden" 
				                                    			value="<?php echo $dname;?>" 
				                                    			class="form-control"/>
				                                    			<input name="socialicon<?php echo $i;?>" 
				                                    			type="hidden" 
				                                    			value="<?php echo $icon;?>" 
				                                    			class="form-control"/>
							                                    <input name="socialurl<?php echo $i;?>" 
							                                    class="form-control" 
							                                    type="url" 
							                                    value="<?php if(isset($csurl)){echo $csurl;}?>" 
							                                    Placeholder="The web address."/>				                                    
							                                </div><!-- /.input group -->
						                                </div><!-- /.form group -->
				                                	</div>
		                                	<?php
					      	...
					      	<div id="headBlock_group1edit" class="panel-collapse collapse in">
                                <div class="col-md-12 social-field-hold">
                                    ...
                                    <?php 
	                                    ...
	                                    // if any.
	                                    $socialdata=array();
	                                    /*$test='{"socialentry1":{"socialname":"Website","socialicon":"fa-chrome",
			"socialurl":"www.google.com/?q=indeuc"},"socialentry2":{"socialname2":"Facebook","socialicon2":"fa-facebook",
			"socialurl":"facebook.com/gokuzimaki"},"socialentry3":{"socialname3":"Twitter","socialicon3":"fa-twitter",
			"socialurl":"twitter.com/gokuzimaki"},"socialentry4":{"socialname4":"Googleplus","socialicon4":"fa-google-plus",
			"socialurl":""},"socialentry5":{"socialname5":"Linkedin","socialicon5":"fa-linkedin",
			"socialurl":""},"socialentry6":{"socialname6":"Pinterest","socialicon6":"fa-pinterest",
			"socialurl":""},"socialentry7":{"socialname7":"Instagram","socialicon7":"fa-instagram",
			"socialurl":"indeuc"},"total":"7"}';*/
										// $testdata=json_decode($test,true);
										// var_dump($testdata);
	                                    if($row['projectsocials']!==""){
	                                    	// echo $row['projectsocials'];
	                                    	$sdata=JSONtoPHP($row['projectsocials']);
	                                    	$socialdata=$sdata['arrayoutput'];
	                                    	// echo $socialdata['error'];
		                                    // var_dump($socialdata);
	                                    }
	                                    // prep the default social media info
		                                	...
		                                	<div class="col-md-3 multi_content_hold " data-name="social" data-type="<?php echo $ttype;?>" data-cid="<?php echo $i?>">
				                                <div class="form-group">
				                                    ...
				                                    <div class="input-group">
		                                    			...
		                                    			<input name="socialname<?php echo $i;?>" 
		                                    			type="hidden" value="<?php echo $dname;?>" 
		                                    			class="form-control"/>
		                                    			<input name="socialicon<?php echo $i;?>" 
		                                    			type="hidden" 
		                                    			value="<?php echo $icon;?>" 
		                                    			class="form-control"/>
					                                    <input 
					                                    name="socialurl<?php echo $i;?>" 
					                                    class="form-control" 
					                                    type="url" 
					                                    value="<?php 
					                                    if(isset($csurl)){echo $csurl;}?>" 
					                                    Placeholder="The web address."/>				                                    
					                                </div><!-- /.input group -->
				                                </div><!-- /.form group -->
		                                	</div>
