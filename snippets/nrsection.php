<?php
	...
	$notuid=isset($_SESSION['aduid'.$logpart.''])&&$_SESSION['aduid'.$logpart.'']!==""?
	$_SESSION['aduid'.$logpart.'']:1;
	$parentheader=isset($_SESSION['parentheader'.$logpart.''])&&
	$_SESSION['parentheader'.$logpart.'']!==""?$_SESSION['parentheader'.$logpart.'']:"1";
	...
	*/
	...
	if($notrdtype==""){
		...
		if($returl==""){
			// echo $parentheader;
			if($parentheader=="rootadmin"||strtolower($parentheader)=="super user"
				||strtolower($parentheader)=="superuser"){
