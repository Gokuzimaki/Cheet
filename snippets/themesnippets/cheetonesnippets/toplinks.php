<?php
    ...
    // check if there is a specific type of header to be displayed by monitoring the
    // header '$mpagetoplink_type' variable. If it isnt reay, create it
    if(!isset($mpagetoplink_type)){
      $mpagetoplink_type="";
    }
      ...
      <div class="container">
        <nav class="nav-main mega-menu">
          <ul class="nav nav-pills nav-main" id="mainMenu">
            <?php
              if($mpagetoplink_type=="1"||$mpagetoplink_type==""){
            ?>
                    ...
                    <div class="mega-menu-content">
                      <div class="row">
                        <div class="col-md-12">
                          <div class="droplogin">
                            <?php
                              $formtruetype="droplogin";
                            ?>
                            <form action="<?php echo $host_addr;?>snippets/basiclog.php" 
                              method="POST" id="login-form"
                              name="<?php echo $formtruetype;?>">
                              <div class="col-md-12 _drop-login">
                              ...
                              <div class="col-md-12">
                                ...
                                username-:-input<|>
                                password-:-input"/>
                                <input type="hidden" name="errormap" value="logtype-:-Select an account type from the list provided.<|>name-:-Please provide the name for this category<|>
                                usersubtype-:-Please Choose a specific account type from the sublist<|>
                                username-:-Provide your email address or username<|>
                                password-:-Please provide your password"/>
                                <input type="hidden" name="formdata" value="<?php echo $formtruetype;?>"/>
                                <a href="<?php echo $host_addr;?>signupin.php" 
                                  class="btn btn-link forgot-password-link">Register with cheet</a>
        ...
        <?php
          // this section is for displaying after-nav content like floating searchboxes
          // amongst others
            if($mpagetoplink_type=="1"||$mpagetoplink_type==""){
          ?>
