<?php
	...
	include($host_tpathplain.'modules/headcontentparentdefault.php'); 
		  ...
		  <div id="lms_simple_slider" class="carousel slide" data-ride="carousel"> 
		    ...
		    <div class="carousel-inner">
		      <div class="item active"> 
		        <img src="'.$host_addr.'images/cheetimagesone/slider/slider3.jpg" 
		        class="animated bounceInRight lms_delay_01" alt="simple slider slide-1">
		        <div class="carousel-caption lms_ss_caption animated 
		        bounceInRight lms_delay_03">
		            <h1 class="lms_label lms_ss_heading">"Education is not preparation 
		            for life; Education is life itself"</h1>
		        	<h3>John Dowey</h3>
		        </div>
		      </div>
		      <div class="item"> 
		        <img src="'.$host_addr.'images/cheetimagesone/slider/slider2.jpg" 
		        class="animated bounceInRight lms_delay_01" alt="simple slider slide-1">
		        <div class="carousel-caption lms_ss_caption animated bounceInRight 
		        lms_delay_03">
		        	<div class="lms_ss_icon">
		            	<div class="lms_ss_laptop"><i class="fa fa-laptop"></i></div>
		            </div>
		            <h1 class="lms_ss_heading lms_label">"Learn, Learn and Learn 
		            some more"</h1>	
		        	<h3>Cheet</h3>
		        </div>
		      </div>
		      <div class="item"> 
		        <img src="'.$host_addr.'images/cheetimagesone/slider/slider1.jpg" 
		        class="animated bounceInRight lms_delay_01" alt="simple slider slide-1">
		        <div class="carousel-caption lms_ss_caption animated bounceInRight 
		        lms_delay_03">
		            <h1 class="lms_ss_heading lms_label">"Education is the key to unlock 
		            the golden door of freedom"</h1>			
...
<html>
	<head>
		...
		<?php 
			include('./snippets/themesnippets/cheetonesnippets/themestyles.php');
		?>
	</head>