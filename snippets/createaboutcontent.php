			        ...
			        <div class="row">
						...
						<?php
							if($pagetype=="trustees"){
								// set up the generaldatamodule information to handle form display
								$contentgroupdatageneral['contentgdset']['showhideintro']="display:none;";
								$contentgroupdatageneral['contentgdset']['showhidestatus']="";
								$contentgroupdatageneral['contentgdset']['contenttexttitleout']="Team Members Full Name";
								$contentgroupdatageneral['contentgdset']['contenttextimageout']="Team Members Photograph";
								$contentgroupdatageneral['contentgdset']['contentplaceholdertitleout']="Fullname";
								$contentgroupdatageneral['contentgdset']['contenttextsubtitleout']="Position <small>e.g \"Team Member\"</small>";
								$contentgroupdatageneral['contentgdset']['contentplaceholdersubtitleout']="Provide Team Members position";
								$contentgroupdatageneral['contentgdset']['contenttextcontentout']="Team Member Profile";
								$contentgroupdatageneral['contentgdset']['contentattrcontentout']='data-mce="true" data-errmsg="Please provide the Team Members\'s details/Bio"';
								$contentgroupdatageneral['contentgdset']['contentplaceholdercontentout']="Team Member full bio";
