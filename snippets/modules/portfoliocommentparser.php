<?php 
	...
	// plugins
	// the variable $curpotdata is expected to be available
	if(isset($curpotdata)){
		...
		if($curpotdata['commenttype']=="normal"){
			
			$blog_comment_count=& $curpotdata['viewercommentcount'];
			$blog_comment_data=& $curpotdata['viewercomments']; 

		}else if($curpotdata['commenttype']=="disqus"){
			...
			data-disqus-url="'.$curpotdata['pagelink'].'"
			data-disqus-identifier="'.$curpotdata['id'].'_portfolio">';
		...
		$c_form_fields='
			<input type="hidden" name="entryvariant" value="createportcomment"/>
			<input type="hidden" name="entryid" 
			value="'.$curpotdata['id'].'"/>
			<input type="hidden" name="returl" 
			value="'.$curpotdata['pagelink'].'"/>';
