			...
			for($i=0;$i<$numrows;$i++){
				...
				$tddataoutput=isset($tdataoutput)&&$tdataoutput!==""?$tdataoutput:'
					...
					<td name="trcontrolpoint">
						...
						data-type="editgeneraldata" data-divid="'.$id.'" '.$datamapout.'>
							Edit
						</a>
					</td>
				';
		...
		if($numrows>0){
			...
			for($i=0;$i<$numrows;$i++){
				...
				*/
				...
				$seometakeywords=isset($row['seometakeywords'])?
				$row['seometakeywords']:""; 
				// for retrieving the prefered meta key words for a post
				$seometadescription=isset($row['seometadescription'])?
