...
<html>
  <head>
    ...
    <link rel="shortcut icon" href="<?php echo $host_addr;?>images/muyiwaslogo.png" type="image/png"/>
  ...
  <body class="skin-yellow login-page">
      ...
      <div class="login-logo">
        <a href="index.php"><b>Cheet Admin</b></a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        ...
        <form action="../snippets/basiclog.php" name="adminloginform" method="post">
          ...
          <div class="row">
            ...
            <div class="col-xs-4">
            	<input type="hidden" name="crypttype" value=""/>
