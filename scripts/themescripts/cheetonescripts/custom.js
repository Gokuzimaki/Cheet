  ...
  "use strict";
	...
	jQuery(document).ready(function($) {
		...
		$('.lms_list_view').on("click",function(){
			$('.lms_course > div').addClass('lms_course_list');
			$('.lms_course > div').removeClass('animated fadeInDown');
			$('.lms_course > div').addClass('animated fadeInLeft');
			$('.lms_course > div').removeClass('lms_course_grid');
		});
		
		$('.lms_grid_view').on("click",function(){
			$('.lms_course > div').removeClass('animated fadeInLeft');
			$('.lms_course > div').addClass('animated fadeInDown');
			$('.lms_course > div').addClass('lms_course_grid');
			$('.lms_course > div').removeClass('lms_course_list');
		});	
		...
		/*** Section for custom codes for cheet ***/

		// dropdown login serviceprovider list switcher
